...
# este script fue usado para notificar a determinadas personadas sobre teams 
# de su contraseña y usuario sobre los ambientes de pruebas y Productivo sobre ICEBERG
import pyautogui
import pyperclip
